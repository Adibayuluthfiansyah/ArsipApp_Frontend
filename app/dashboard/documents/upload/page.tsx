...
export default function UploadDocumentPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!formData.title || !formData.document_number || !formData.document_date || !formData.category_id) {
        ...
        <div className="space-y-6 max-w-3xl">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Isi form di bawah ini untuk mengupload dokumen baru. Tanda (*) wajib diisi.
                    </CardDescription>
                </CardHeader>
                <CardContent>
